...
@Composable
inline fun <reified T> CardWords(
    items: List<T>,
    onItemRemoved: (T, SwipedOutDirection) -> Unit,
    onEmpty: () -> Unit = {},
    CardWordsController: CardWordsController = rememberCardWordsController(),
    stackCount: Int = 2,
        ...
        list.forEachIndexed { index, item ->
            key(item) {
                ...
                if (index == list.lastIndex) {
                    CardWordsController.currentCardController = cardController
                }
